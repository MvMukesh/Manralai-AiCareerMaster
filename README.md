...
|-----------------|-----------|
| OpenCV Basic's like --> (Pixel Manipulation, Getting & setting pixels, Image translation, Image rotation, Interpolation Methods and comarison, Image Fliping, Image Croping, Image Arithmetic, Image bitwise, Image Masking, Image Channels Splitting & Merging )| [Link](https://www.kaggle.com/code/mukeshmanral/opencv-basic-0/)
