...
|📙 TransferLearning `AlexNet-(2012)` -ImageClassification  |[Link](https://www.kaggle.com/code/mukeshmanral/alexnet/notebook) |
|📙 TransferLearning `VGGNet-(2014)` -ImageClassification  | |
|📙 TransferLearning `ResNet-(2015)` -ImageClassification  |[Link](https://www.kaggle.com/code/mukeshmanral/imageclassification-transferlearning-resnet/notebook) | |
